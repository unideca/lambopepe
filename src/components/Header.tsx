...
const Header : FC<HeaderProps> = ({tokenHomeRef, tokenServiceRef, tokenAboutRef, tokenRef, tokenRoadmapRef, contactRef }) => {
    ...
    return (
        ...
        <Flex
            ...
            bgColor={isScrolled ? "gray.400" : "transparent"}
            alignItems="center"
        ...
        >
            ...
            as="a"
            href="/" >
                <Img w="80px" src="images/lamboplogo.png" zIndex={4}/>
                <Text w="160px" fontSize="24px" position="absolute" left="92px" top="20px">LamboPepe</Text>
            </Flex>
            ...
            <Flex gap={4} alignItems="center">
                <Button
                    ...
                    overflow="hidden"
                    as="a" //down
                    href="/documents/LamboPepe_Whitepaper_eng.pdf" //down
                    download="LamboPepe_Whitepaper_eng.pdf" // 다운로드 속성 추가
                    _hover= {{
